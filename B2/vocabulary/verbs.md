...
| ablehnen | to reject | رد کردن | lehnte ab | habe abgelehnt | haben | reg. | — | Er lehnt den Vorschlag ab. |
| befürworten | to support/approve | حمایت کردن | befürwortete | habe befürwortet | haben | reg. | — | Sie befürwortet die Reform. |
| einsehen | to realize | درک کردن | sah ein | habe eingesehen | haben | reg. | — | Er sieht seinen Fehler ein. |
| vermuten | to suspect | گمان کردن | vermutete | habe vermutet | haben | reg. | — | Ich vermute, dass... |

## 🪞 Reflexion (Reflection)

| German | English | Persian | Präteritum | Perfekt | Auxiliary | Class | Frame | Example |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| reflektieren | to reflect | تأمل کردن | reflektierte | habe reflektiert | haben | reg. | — | Er reflektiert über sein Leben. |
| abwägen | to weigh up | سبکسنگی کردن | wog ab | habe abgewogen | haben | irr. | — | Sie wog die Vor- und Nachteile ab. |
| einschätzen | to assess | ارزیابی کردن | schätzte ein | habe eingeschätzt | haben | reg. | — | Er schätzt die Lage ein. |
| beurteilen | to evaluate | قضاوت کردن | beurteilte | habe beurteilt | haben | reg. | — | Sie beurteilt die Situation. |
| hinterfragen | to question | زیر سؤال بردن | hinterfragte | habe hinterfragt | haben | reg. | — | Er hinterfragt die Traditionen. |
| überdenken | to reconsider | بازاندیشی کردن | überdachte | habe überdacht | haben | reg. | — | Sie überdenkt ihre Entscheidung. |
| nachdenken | to think about | فکر کردن | dachte nach | habe nachgedacht | haben | irr. | — | Er denkt darüber nach. |
| bedenken | to consider | در نظر گرفتن | bedachte | habe bedacht | haben | irr. | — | Sie bedenkt alle Aspekte. |
| erwägen | to consider | بررسی کردن | erwog | habe erwogen | haben | reg. | — | Er erwägt die Möglichkeiten. |
| sich besinnen | to reflect | تأمل کردن | besann sich | habe besonnen | haben | irr. | — | Sie besinnt sich auf die Vergangenheit. |
| zurückblicken | to look back | نگاه کردن به گذشته | blickte zurück | habe zurückgeblickt | haben | reg. | — | Er blickt auf sein Leben zurück. |
| vorausdenken | to think ahead | به آینده فکر کردن | dachte voraus | habe vorausgedacht | haben | irr. | — | Sie denkt voraus. |
...
| sich freuen | to be happy | خوشحال بودن | freute sich | habe mich gefreut | haben | reg. | — | Ich freue mich auf dich. |
| sich ärgern | to be annoyed | عصبانی شدن | ärgerte sich | habe mich geärgert | haben | reg. | — | Er ärgert sich über den Lärm. |
| enttäuschen | to disappoint | ناامید کردن | enttäuschte | habe enttäuscht | haben | reg. | — | Sie hat mich enttäuscht. |
| überraschen | to surprise | شگفت زده کردن | überraschte | habe überrascht | haben | reg. | — | Er hat mich überrascht. |
| betrüben | to sadden | غمگین کردن | betrübte | habe betrübt | haben | reg. | — | Die Nachricht betrübt mich. |
| aufregen | to excite/irritate | هیجان زده/عصبانی کردن | regte auf | habe aufgeregt | haben | reg. | — | Das regt mich auf. |
| beruhigen | to calm down | آرام کردن | beruhigte | habe beruhigt | haben | reg. | — | Er beruhigt das Kind. |
| sich sorgen | to worry | نگران بودن | sorgte sich | habe mich gesorgt | haben | reg. | — | Sie sorgt sich um ihre Kinder. |
...
| zitieren | to cite | نقل قول کردن | zitierte | habe zitiert | haben | reg. | — | Sie zitiert die Quelle. |
| messen | to measure | اندازه گرفتن | maß | habe gemessen | haben | irr. | — | Er misst die Temperatur. |
...
| abstrahieren | to abstract | انتزاعی کردن | abstrahierte | habe abstrahiert | haben | reg. | — | Er abstrahiert von den Details. |
| definieren | to define | تعریف کردن | definierte | habe definiert | haben | reg. | — | Sie definiert den Begriff. |
| interpretieren | to interpret | تفسیر کردن | interpretierte | habe interpretiert | haben | reg. | — | Er interpretiert den Text. |
| problematisieren | to problematize | مسئله ساز کردن | problematisierte | habe problematisiert | haben | reg. | — | Sie problematisiert die Annahme. |
...
| verabschieden | to pass (law) | تصویب کردن | verabschiedete | habe verabschiedet | haben | reg. | — | Das Parlament verabschiedet das Gesetz. |
| einsetzen | to deploy/use | به کار گرفتن | setzte ein | habe eingesetzt | haben | reg. | — | Er setzt seine Mittel ein. |
| durchsetzen | to enforce | اجرا کردن | setzte durch | habe durchgesetzt | haben | reg. | — | Sie setzt die Regel durch. |
...
| sparen | to save | پس‌انداز کردن | sparte | habe gespart | haben | reg. | — | Er spart Geld für die Zukunft. |
| ausgeben | to spend | خرج کردن | gab aus | habe ausgegeben | haben | irr. | — | Sie gibt viel Geld aus. |
| gewinnen | to win | برنده شدن | gewann | habe gewonnen | haben | irr. | — | Er gewinnt den Auftrag. |
| verlieren | to lose | باختن | verlor | habe verloren | haben | irr. | — | Sie verliert ihre Kunden. |
| wachsen | to grow | رشد کردن | wuchs | habe gewachsen | haben | irr. | — | Die Wirtschaft wächst. |
| sinken | to fall/decrease | کاهش یافتن | sank | habe gesunken | haben | irr. | — | Die Preise sinken. |
| steigen | to rise/increase | افزایش یافتن | stieg | habe gestiegen | haben | irr. | — | Die Nachfrage steigt. |
| bezahlen | to pay | پرداخت کردن | bezahlte | habe bezahlt | haben | reg. | — | Er bezahlt die Rechnung. |
| schulden | to owe | بدهکار بودن | schuldete | habe geschuldet | haben | reg. | — | Sie schuldet mir Geld. |

## 🎨 Kunst (Art)

| German | English | Persian | Präteritum | Perfekt | Auxiliary | Class | Frame | Example |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| komponieren | to compose | آهنگسازی کردن | komponierte | habe komponiert | haben | reg. | — | Er komponiert Musik. |
| malen | to paint | نقاشی کردن | malte | habe gemalt | haben | reg. | — | Sie malt ein Bild. |
| zeichnen | to draw | طراحی کردن | zeichnete | habe gezeichnet | haben | reg. | — | Er zeichnet eine Skizze. |
| gestalten | to design | طراحی کردن | gestaltete | habe gestaltet | haben | reg. | — | Sie gestaltet den Raum. |
| entwerfen | to design/draft | طراحی کردن | entwarf | habe entworfen | haben | irr. | — | Er entwirft einen Plan. |
| ausstellen | to exhibit | به نمایش گذاشتن | stellte aus | habe ausgestellt | haben | reg. | — | Sie stellt ihre Werke aus. |
| singen | to sing | خواندن | sang | habe gesungen | haben | irr. | — | Er singt ein Lied. |
| tanzen | to dance | رقصیدن | tanzte | habe getanzt | haben | reg. | — | Sie tanzt wunderbar. |
| inszenieren | to stage | صحنه پردازی کردن | inszenierte | habe inszeniert | haben | reg. | — | Er inszeniert ein Stück. |
| fotografieren | to photograph | عکاسی کردن | fotografierte | habe fotografiert | haben | reg. | — | Sie fotografiert die Landschaft. |
| ausdrücken | to express | بیان کردن | drückte aus | habe ausgedrückt | haben | reg. | — | Er drückt seine Gefühle aus. |
| darstellen | to represent | نمایش دادن | stellte dar | habe dargestellt | haben | reg. | — | Sie stellt die Szene dar. |
...
| German | English | Persian | Präteritum | Perfekt | Auxiliary | Class | Frame | Example |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| programmieren | to program | برنامه‌نویسی کردن | programmierte | habe programmiert | haben | reg. | — | Er programmiert eine App. |
| automatisieren | to automate | خودکار کردن | automatisierte | habe automatisiert | haben | reg. | — | Sie automatisiert den Prozess. |
| digitalisieren | to digitize | دیجیتالی کردن | digitalisierte | habe digitalisiert | haben | reg. | — | Er digitalisiert die Dokumente. |
| robotisieren | to robotize | رباتیک کردن | robotisierte | habe robotisiert | haben | reg. | — | Sie robotisiert die Fabrik. |
| klicken | to click | کلیک کردن | klickte | habe geklickt | haben | reg. | — | Er klickt auf den Link. |
| downloaden | to download | دانلود کردن | downloadete | habe gedownloadet | haben | reg. | — | Sie lädt die Datei herunter. |
...
| German | English | Persian | Präteritum | Perfekt | Auxiliary | Class | Frame | Example |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| integrieren | to integrate | ادغام کردن | integrierte | habe integriert | haben | reg. | — | Er integriert sich in die Gesellschaft. |
| diskriminieren | to discriminate | تبعیض قائل شدن | diskriminierte | habe diskriminiert | haben | reg. | — | Sie diskriminiert andere. |
| marginalisieren | to marginalize | حاشیه راندن | marginalisierte | habe marginalisiert | haben | reg. | — | Er marginalisiert die Minderheit. |
| partizipieren | to participate | مشارکت کردن | partizierte | habe partiziiert | haben | reg. | — | Sie partiziiert an der Wahl. |
| emigrieren | to emigrate | مهاجرت کردن | emigrierte | habe emigriert | haben | reg. | — | Er emigriert ins Ausland. |
| immigrieren | to immigrate | مهاجرت کردن | immigrierte | habe immigriert | haben | reg. | — | Sie immigriert nach Deutschland. |
| kommunizieren | to communicate | ارتباط برقرار کردن | kommunizierte | habe kommuniziert | haben | reg. | — | Sie kommuniziert mit den Nachbarn. |
| kooperieren | to cooperate | همکاری کردن | kooperierte | habe kooperiert | haben | reg. | — | Er kooperiert mit anderen. |
| organisieren | to organize | سازماندهی کردن | organisierte | habe organisiert | haben | reg. | — | Sie organisiert eine Veranstaltung. |
| mobilisieren | to mobilize | بسیج کردن | mobilisierte | habe mobilisiert | haben | reg. | — | Er mobilisiert die Bevölkerung. |
| protestieren | to protest | اعتراض کردن | protestierte | habe protestiert | haben | reg. | — | Sie protestiert gegen die Reform. |
| teilnehmen | to participate | شرکت کردن | nahm teil | habe teilgenommen | haben | irr. | — | Er nimmt an der Wahl teil. |
...
| German | English | Persian | Präteritum | Perfekt | Auxiliary | Class | Frame | Example |
|--------|--------|--------|--------|--------|--------|--------|--------|--------|
| berichten | to report | گزارش دادن | berichtete | habe berichtet | haben | reg. | — | Er berichtet über das Ereignis. |
| senden | to broadcast | پخش کردن | sandte | habe gesendet | haben | irr. | — | Der Sender sendet die Nachricht. |
...
| genesen | to recover | بهبود یافتن | genas | habe genesen | haben | irr. | — | Sie ist von der Krankheit genesen. |
| leiden | to suffer | رنج بردن | litt | habe gelitten | haben | irr. | — | Er leidet an einer Krankheit. |
| sterben | to die | مردن | starb | habe gestorben | haben | irr. | — | Sie ist gestorben. |
| vorbeugen | to prevent | پیشگیری کردن | vorbeugte | habe vorgebeugt | haben | reg. | — | Er vorbeugt Krankheiten. |
| verordnen | to prescribe | نسخه پیچی کردن | verordnete | habe verordnet | haben | reg. | — | Der Arzt verordnet ein Medikament. |
| spritzen | to inject | تزریق کردن | spritzte | habe gespritzt | haben | reg. | — | Die Ärztin spritzt das Medikament. |
| untersuchen | to examine | معاینه کردن | untersuchte | habe untersucht | haben | reg. | — | Der Arzt untersucht den Patienten. |
