...
> **Level**: B2 (Upper Intermediate) | **Words**: 600+ | **Format**: Categories with tables
...
| 🔴 die These | thesis | پایان‌نامه/thesis | f. | die | die Thesen | Nom/Acc/Dat/Gen |
| 🔴 die Antithese | antithesis | ضدهویت | f. | die | die Antithesen | Nom/Acc/Dat/Gen |
| 🔴 die Quantenphysik | quantum physics | فیزیک کوانتومی | f. | die | die Quantenphysik | Nom/Acc/Dat/Gen |
| 🔴 die Evolutionslehre | theory of evolution | نظریه تکامل | f. | die | die Evolutionslehren | Nom/Acc/Dat/Gen |
| 🔴 die Genetik | genetics | ژنتیک | f. | die | die Genetik | Nom/Acc/Dat/Gen |
| 🔴 die Biologie | biology | زیست‌شناسی | f. | die | die Biologie | Nom/Acc/Dat/Gen |
| 🔴 die Chemie | chemistry | شیمی | f. | die | die Chemie | Nom/Acc/Dat/Gen |
| 🔴 die Physik | physics | فیزیک | f. | die | die Physik | Nom/Acc/Dat/Gen |
| 🔴 die Astronomie | astronomy | نجوم | f. | die | die Astronomie | Nom/Acc/Dat/Gen |
| 🔴 die Geologie | geology | زمین‌شناسی | f. | die | die Geologie | Nom/Acc/Dat/Gen |
| 🔴 die Meteorologie | meteorology | هواشناسی | f. | die | die Meteorologie | Nom/Acc/Dat/Gen |
| ⭐ die These | thesis | تز/فرضیه | f. | die | die Thesen | Nom/Acc/Dat/Gen |
| ⭐ die Prüfung | test/exam | آزمون | f. | die | die Prüfungen | Nom/Acc/Dat/Gen |
| ⭐ die Studie | study | مطالعه | f. | die | die Studien | Nom/Acc/Dat/Gen |
...
| 🔴 die Bipolarität | bipolarity | دوقطبی | f. | die | die Bipolaritäten | Nom/Acc/Dat/Gen |
...
| ⭐ das Geld | money | پول | n. | das | die Gelder | Nom/Acc/Dat/Gen |
| ⭐ die Steuer | tax | مالیات | f. | die | die Steuern | Nom/Acc/Dat/Gen |
...
| ⭐ das Museum | museum | موزه | n. | das | die Museen | Nom/Acc/Dat/Gen |
| ⭐ die Galerie | gallery | گالری | f. | die | die Galerien | Nom/Acc/Dat/Gen |
| ⭐ die Ausstellung | exhibition | نمایشگاه | f. | die | die Ausstellungen | Nom/Acc/Dat/Gen |
| 🔴 die Fotografie | photography | عکاسی | f. | die | die Fotografien | Nom/Acc/Dat/Gen |
| 🔴 die Architektur | architecture | معماری | f. | die | die Architekturen | Nom/Acc/Dat/Gen |
| 🔴 die Komposition | composition | آهنگسازی | f. | die | die Kompositionen | Nom/Acc/Dat/Gen |
| 🔴 die Performance | performance | اجرا | f. | die | die Performances | Nom/Acc/Dat/Gen |
| 🔴 die Installation | installation | نصب هنری | f. | die | die Installationen | Nom/Acc/Dat/Gen |
| 🔴 die Collage | collage | کلاژ | f. | die | die Collagen | Nom/Acc/Dat/Gen |
| 🔴 die Mischtechnik | mixed media | تکنیک ترکیبی | f. | die | die Mischtechniken | Nom/Acc/Dat/Gen |
| ⭐ das Kunstwerk | artwork | اثر هنری | n. | das | die Kunstwerke | Nom/Acc/Dat/Gen |
| ⭐ der Künstler | artist | هنرمند | m. | der | die Künstler | Nom/Acc/Dat/Gen |
| 🔴 die Bildhauerei | sculpture | مجسمه‌سازی | f. | die | die Bildhauereien | Nom/Acc/Dat/Gen |
| 🔴 die Grafik | graphic art | گرافیک | f. | die | die Grafiken | Nom/Acc/Dat/Gen |
...
| 🔴 die Entwicklungspsychologie | developmental psychology | روان‌شناسی رشد | f. | die | die Entwicklungspsychologien | Nom/Acc/Dat/Gen |
| 🔴 die Sozialpsychologie | social psychology | روان‌شناسی اجتماعی | f. | die | die Sozialpsychologien | Nom/Acc/Dat/Gen |
| 🔴 die Neurologie | neurology | عصب‌شناسی | f. | die | die Neurologien | Nom/Acc/Dat/Gen |
| 🔴 die Psychiatrie | psychiatry | روان‌پزشکی | f. | die | die Psychiatrien | Nom/Acc/Dat/Gen |
| ⭐ das Gedächtnis | memory | حافظه | n. | das | die Gedächtnisse | Nom/Acc/Dat/Gen |
| ⭐ die Angst | fear | ترس | f. | die | die Ängste | Nom/Acc/Dat/Gen |
| ⭐ die Freude | joy | شادی | f. | die | die Freuden | Nom/Acc/Dat/Gen |
| ⭐ die Traurigkeit | sadness | غم | f. | die | die Traurigkeiten | Nom/Acc/Dat/Gen |
| ⭐ die Wut | anger | خشم | f. | die | die Wüte | Nom/Acc/Dat/Gen |
| 🔴 die Phobie | phobia | فوبیا | f. | die | die Phobien | Nom/Acc/Dat/Gen |
| 🔴 die Paranoia | paranoia | پارانویا | f. | die | die Paranoien | Nom/Acc/Dat/Gen |
| 🔴 die Schizophrenie | schizophrenia | اسکیزوفرنی | f. | die | die Schizophrenien | Nom/Acc/Dat/Gen |
| 🔴 die Depression | depression | افسردگی | f. | die | die Depressionen | Nom/Acc/Dat/Gen |
| 🔴 die Manie | mania | مانی | f. | die | die Manien | Nom/Acc/Dat/Gen |
| 🔴 die Neugier | curiosity | کنجکاوی | f. | die | die Neugierde | Nom/Acc/Dat/Gen |
| 🔴 die Impulsivität | impulsivity | تکانشگری | f. | die | die Impulsivitäten | Nom/Acc/Dat/Gen |
| 🔴 die Selbstwirksamkeit | self-efficacy | کارآمدی خود | f. | die | die Selbstwirksamkeiten | Nom/Acc/Dat/Gen |
| 🔴 die Konditionierung | conditioning | شرطی‌سازی | f. | die | die Konditionierungen | Nom/Acc/Dat/Gen |
| ⭐ die Symptome | symptom | علائم | f. | die | die Symptome | Nom/Acc/Dat/Gen |
| ⭐ die Diagnose | diagnosis | تشخیص | f. | die | die Diagnosen | Nom/Acc/Dat/Gen |
...
| German | English | Persian | Gender | Article | Plural | Cases |
|--------|---------|---------|--------|---------|--------|-------|
| 🔴 die Künstliche Intelligenz | artificial intelligence | هوش مصنوعی | f. | die | die Künstlichen Intelligenzen | Nom/Acc/Dat/Gen |
| 🔴 die Robotik | robotics | رباتیک | f. | die | die Robotik | Nom/Acc/Dat/Gen |
| 🔴 die Digitalisierung | digitalization | دیجیتالی‌شدن | f. | die | die Digitalisierungen | Nom/Acc/Dat/Gen |
| 🔴 die Automatisierung | automation | خودکارسازی | f. | die | die Automatisierungen | Nom/Acc/Dat/Gen |
| 🔴 die Biotechnologie | biotechnology | بیوتکنولوژی | f. | die | die Biotechnologien | Nom/Acc/Dat/Gen |
...
| 🔴 die Programmierung | programming | برنامه‌نویسی | f. | die | die Programmierungen | Nom/Acc/Dat/Gen |
| 🔴 die Datenverarbeitung | data processing | پردازش داده | f. | die | die Datenverarbeitungen | Nom/Acc/Dat/Gen |
| 🔴 die Kryptowährung | cryptocurrency | ارز دیجیتال | f. | die | die Kryptowährungen | Nom/Acc/Dat/Gen |
| 🔴 die Blockchain | blockchain | بلاکچین | f. | die | die Blockchains | Nom/Acc/Dat/Gen |
| 🔴 die Drohne | drone | پهپاد | f. | die | die Drohnen | Nom/Acc/Dat/Gen |
| ⭐ der Drucker | printer | پرینتر | m. | der | die Drucker | Nom/Acc/Dat/Gen |
| 🔴 die Intelligenz | intelligence | هوش | f. | die | die Intelligenzen | Nom/Acc/Dat/Gen |
| 🔴 die Maschine | machine | ماشین | f. | die | die Maschinen | Nom/Acc/Dat/Gen |
...
| 🔴 die Umweltverschmutzung | environmental pollution | آلودگی محیط زیست | f. | die | die Umweltverschmutzungen | Nom/Acc/Dat/Gen |
| ⭐ die Natur | nature | طبیعت | f. | die | die Naturen | Nom/Acc/Dat/Gen |
| ⭐ die Luft | air | هوا | f. | die | die Lüfte | Nom/Acc/Dat/Gen |
| ⭐ das Wasser | water | آب | n. | das | die Wasser | Nom/Acc/Dat/Gen |
...
| 🔴 die Photosynthese | photosynthesis | فتوسنتز | f. | die | die Photosynthesen | Nom/Acc/Dat/Gen |
| 🔴 die Ozonschicht | ozone layer | لایه ازن | f. | die | die Ozonschichten | Nom/Acc/Dat/Gen |
| ⭐ die Verschmutzung | pollution | آلودگی | f. | die | die Verschmutzungen | Nom/Acc/Dat/Gen |
...
| 🔴 die Gesellschaft | society | جامعه | f. | die | die Gesellschaften | Nom/Acc/Dat/Gen |
| ⭐ die Familie | family | خانواده | f. | die | die Familien | Nom/Acc/Dat/Gen |
| ⭐ die Generation | generation | نسل | f. | die | die Generationen | Nom/Acc/Dat/Gen |
| ⭐ die Tradition | tradition | سنت | f. | die | die Traditionen | Nom/Acc/Dat/Gen |
| ⭐ die Religion | religion | دین | f. | die | die Religionen | Nom/Acc/Dat/Gen |
| ⭐ die Sprache | language | زبان | f. | die | die Sprachen | Nom/Acc/Dat/Gen |
| 🔴 die Sozialstruktur | social structure | ساختار اجتماعی | f. | die | die Sozialstrukturen | Nom/Acc/Dat/Gen |
| 🔴 die Geschlechterrolle | gender role | نقش جنسیتی | f. | die | die Geschlechterrollen | Nom/Acc/Dat/Gen |
| 🔴 die Gleichstellung | equality | برابری | f. | die | die Gleichstellungen | Nom/Acc/Dat/Gen |
...
| 🔴 die Toleranz | tolerance | مدارا | f. | die | die Toleranzen | Nom/Acc/Dat/Gen |
| 🔴 die Solidarität | solidarity | همبستگی | f. | die | die Solidaritäten | Nom/Acc/Dat/Gen |
...
| 🔴 die Zensur | censorship | سانسور | f. | die | die Zensuren | Nom/Acc/Dat/Gen |
| 🔴 die Meinungsfreiheit | freedom of speech | آزادی بیان | f. | die | die Meinungsfreiheiten | Nom/Acc/Dat/Gen |
| ⭐ die Zeitung | newspaper | روزنامه | f. | die | die Zeitungen | Nom/Acc/Dat/Gen |
| ⭐ das Fernsehen | television | تلویزیون | n. | das | die Fernsehens | Nom/Acc/Dat/Gen |
| ⭐ das Radio | radio | رادیو | n. | das | die Radios | Nom/Acc/Dat/Gen |
| ⭐ das Internet | internet | اینترنت | n. | das | die Internetze | Nom/Acc/Dat/Gen |
| ⭐ der Sender | station/channel | ایستگاه/شبکه | m. | der | die Sender | Nom/Acc/Dat/Gen |
...
| German | English | Persian | Gender | Article | Plural | Cases |
|--------|---------|---------|--------|---------|--------|-------|
| 🔴 die Epidemiologie | epidemiology | اپیدمیولوژی | f. | die | die Epidemiologien | Nom/Acc/Dat/Gen |
| 🔴 die Prävention | prevention | پیشگیری | f. | die | die Präventionen | Nom/Acc/Dat/Gen |
| ⭐ die Therapie | therapy | درمان | f. | die | die Therapien | Nom/Acc/Dat/Gen |
| ⭐ die Diagnose | diagnosis | تشخیص | f. | die | die Diagnosen | Nom/Acc/Dat/Gen |
| 🔴 die Pharmakologie | pharmacology | داروشناسی | f. | die | die Pharmakologien | Nom/Acc/Dat/Gen |
| 🔴 die Immunologie | immunology | ایمنی‌شناسی | f. | die | die Immunologien | Nom/Acc/Dat/Gen |
| ⭐ der Arzt | doctor | پزشک | m. | der | die Ärzte | Nom/Acc/Dat/Gen |
| ⭐ die Ärztin | female doctor | پزشک زن | f. | die | die Ärztinnen | Nom/Acc/Dat/Gen |
| ⭐ das Krankenhaus | hospital | بیمارستان | n. | das | die Krankenhäuser | Nom/Acc/Dat/Gen |
| ⭐ die Krankheit | disease | بیماری | f. | die | die Krankheiten | Nom/Acc/Dat/Gen |
| ⭐ die Medizin | medicine | دارو/پزشکی | f. | die | die Medizinen | Nom/Acc/Dat/Gen |
| ⭐ die Gesundheit | health | سلامتی | f. | die | die Gesundheiten | Nom/Acc/Dat/Gen |
| 🔴 die Symptomatik | symptomatology | علائم‌شناسی | f. | die | die Symptomatiken | Nom/Acc/Dat/Gen |
| 🔴 die Pathologie | pathology | آسیب‌شناسی | f. | die | die Pathologien | Nom/Acc/Dat/Gen |
| 🔴 die Onkologie | oncology | انکولوژی | f. | die | die Onkologien | Nom/Acc/Dat/Gen |
| 🔴 die Kardiologie | cardiology | قلب‌شناسی | f. | die | die Kardiologien | Nom/Acc/Dat/Gen |
| 🔴 die Neurologie | neurology | عصب‌شناسی | f. | die | die Neurologien | Nom/Acc/Dat/Gen |
| 🔴 die Pädiatrie | pediatrics | اطفال | f. | die | die Pädiatrien | Nom/Acc/Dat/Gen |
| 🔴 die Chirurgie | surgery | جراحی | f. | die | die Chirurgien | Nom/Acc/Dat/Gen |
| 🔴 die Anästhesie | anesthesia | بیهوشی | f. | die | die Anästhesien | Nom/Acc/Dat/Gen |
| 🔴 die Röntgenaufnahme | X-ray | رادیولوژی | f. | die | die Röntgenaufnahmen | Nom/Acc/Dat/Gen |
| 🔴 die Impfung | vaccination | واکسیناسیون | f. | die | die Impfungen | Nom/Acc/Dat/Gen |
| ⭐ das Medikament | medication | دارو | n. | das | die Medikamente | Nom/Acc/Dat/Gen |
| ⭐ die Tablette | pill/tablet | قرص | f. | die | die Tabletten | Nom/Acc/Dat/Gen |
| ⭐ die Dosis | dose | دوز | f. | die | die Dosen | Nom/Acc/Dat/Gen |
| ⭐ die Spritze | syringe/injection | سرنگ | f. | die | die Spritzen | Nom/Acc/Dat/Gen |
| ⭐ das Rezept | prescription | نسخه | n. | das | die Rezepte | Nom/Acc/Dat/Gen |
| ⭐ die Untersuchung | examination | معاینه | f. | die | die Untersuchungen | Nom/Acc/Dat/Gen |
| 🔴 die Blutuntersuchung | blood test | آزمایش خون | f. | die | die Blutuntersuchungen | Nom/Acc/Dat/Gen |
| 🔴 die Operation | operation | عمل جراحی | f. | die | die Operationen | Nom/Acc/Dat/Gen |
