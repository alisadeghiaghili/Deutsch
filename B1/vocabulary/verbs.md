...
| betonen | to emphasize | تأکید کردن | betone | betonte | hat betont | No |
| hervorheben | to highlight | برجسته کردن | hebe hervor | hob hervor | hat hervorgehoben | Yes |
| argumentieren | to argue | استدلال کردن | argumentiere | argumentierte | hat argumentiert | No |
| widerlegen | to refute | رد کردن | widerlege | widerlegte | hat widerlegt | No |
| überzeugen | to convince | متقاعد کردن | überzeuge | überzeugte | hat überzeugt | No |
...
| German | English | Persian | Present (ich) | Past (ich) | Perfect | Separable |
|--------|---------|---------|---------------|------------|---------|-----------|
| diskutieren | to discuss | بحث کردن | diskutiere | diskutierte | habe diskutiert | No |
| debattieren | to debate | مناظره کردن | debattiere | debattierte | habe debattiert | No |
| argumentieren | to argue | استدلال کردن | argumentiere | argumentierte | habe argumentiert | No |
| überzeugen | to convince | متقاعد کردن | überzeuge | überzeugte | habe überzeugt | No |
...
| German | English | Persian | Present (ich) | Past (ich) | Perfect | Separable |
|--------|---------|---------|---------------|------------|---------|-----------|
| empfinden | to feel | احساس کردن | empfinde | empfand | habe empfunden | No |
| fühlen | to feel | احساس کردن | fühle | fühlte | habe gefühlt | No |
| erleben | to experience | تجربه کردن | erlebe | erlebte | habe erlebt | No |
| reagieren | to react | واکنش نشان دادن | reagiere | reagierte | habe reagiert | No |
| beeindrucken | to impress | تحت تأثیر قرار دادن | beeindrucke | beeindruckte | habe beeindruckt | No |
| berühren | to touch | لمس کردن | berühre | berührte | habe berührt | No |
| begeistern | to inspire | الهام بخشیدن | begeistere | begeisterte | habe begeistert | No |
| enttäuschen | to disappoint | ناامید کردن | enttäusche | enttäuschte | habe enttäuscht | No |
| aufregen | to excite | هیجان زده کردن | regere auf | regte auf | habe aufgeregt | Yes |
| beruhigen | to calm | آرام کردن | beruhige | beruhigte | habe beruhigt | No |
| freuen | to please | خوشحال کردن | freue | freute | habe gefreut | No |
| kränken | to hurt | آزرده کردن | kränke | kränkte | habe gekränkt | No |
| betrüben | to sadden | غمگین کردن | betrübe | betrübte | habe betrübt | No |
...
| einstudieren | to rehearse | تمرین کردن | studiere ein | studierte ein | habe eingestudiert | Yes |
| auswendig lernen | to memorize | حفظ کردن | lerne auswendig | lernte auswendig | habe auswendig gelernt | Yes |

## Arbeit / Work

| German | English | Persian | Present (ich) | Past (ich) | Perfect | Separable |
|--------|---------|---------|---------------|------------|---------|-----------|
| verhandeln | to negotiate | مذاکره کردن | verhandle | verhandelte | habe verhandelt | No |
| koordinieren | to coordinate | هماهنگ کردن | koordiniere | koordinierte | habe koordiniert | No |
| organisieren | to organize | سازماندهی کردن | organisiere | organisierte | habe organisiert | No |
| leiten | to lead | رهبری کردن | leite | leitete | habe geleitet | No |
...
| anfangen | to begin | شروع کردن | fange an | fing an | habe angefangen | Yes |
| aufhören | to stop | متوقف شدن | höre auf | hörte auf | habe aufgehört | Yes |
| weitermachen | to continue | ادامه دادن | mache weiter | machte weiter | habe weitergemacht | Yes |
| fertigstellen | to finish | تمام کردن | stelle fertig | stellte fertig | habe fertiggestellt | Yes |
...
| laufen | to walk/run | راه رفتن | laufe | lief | bin gelaufen | No |
| gehen | to go | رفتن | gehe | ging | bin gegangen | No |
| mitnehmen | to take along | با خود بردن | nehme mit | nahm mit | habe mitgenommen | Yes |
| zurückkehren | to return | بازگشت کردن | kehre zurück | kehrte zurück | bin zurückgekehrt | Yes |
...
| verändern | to change | تغییر دادن | verändere | veränderte | habe verändert | No |
| reduzieren | to reduce | کاهش دادن | reduziere | reduzierte | habe reduziert | No |
| verbrauchen | to consume | مصرف کردن | verbrauche | verbrauchte | habe verbraucht | No |
| einsparen | to save | صرفه‌جویی کردن | spare ein | sparte ein | habe eingespart | Yes |
| emissionen vermeiden | to avoid emissions | اجتناب از انتشار | vermeide Emissionen | vermied Emissionen | habe Emissionen vermieden | No |
| klimaneutral sein | to be climate neutral | بی‌طرف اقلیمی بودن | bin klimaneutral | war klimaneutral | bin klimaneutral | No |
| umweltfreundlich sein | to be eco-friendly | دوستدار محیط زیست بودن | bin umweltfreundlich | war umweltfreundlich | bin umweltfreundlich | No |
...
| schaffen | to create | خلق کردن | schaffe | schuf | habe geschaffen | No |
...
| German | English | Persian | Present (ich) | Past (ich) | Perfect | Separable |
|--------|---------|---------|---------------|------------|---------|-----------|
|_existieren | to exist | وجود داشتن | existiere | existierte | habe existiert | No |
...
| komplizieren | to complicate | پیچیده کردن | kompliziere | komplizierte | habe kompliziert | No |
